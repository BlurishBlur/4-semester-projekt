...
public class PlayerInfoHud {
    ...
    public void draw(World world) {
        ...
        font.draw(batch, "Level: " + world.getPlayer().getLevel(), 1150, world.getCurrentRoom().getHeight() - 25);
        font.draw(batch, world.getPlayer().getExperience() + "/100", 1155, world.getCurrentRoom().getHeight() - 65);
        batch.end();
    }
